...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 03, 2022 lúc 05:47 PM
...
CREATE TABLE `review` (
  ...
  `review_detail` varchar(1500) NOT NULL,
...
ALTER TABLE `review`
  ...
  ADD CONSTRAINT `review_ibfk_2` FOREIGN KEY (`id_user`) REFERENCES `member` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
